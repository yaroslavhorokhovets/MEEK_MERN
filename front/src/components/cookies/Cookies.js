...
function Cookies() {
    ...
    return (
        <div className='row static-page cookies' style={contentStyle}>
            <div className="header-page col-md-12 p-0">
                <div className="list-breadcrumbs left-right-offset row m-0">
                    ...
                    <div className="list-breadcrumbs-item">
                        <div className="last-flex-item-container">Cookies</div>
                    </div>
                </div>
                <div className="categories">Click Laboratory, LLC.</div>
                <h1 className="title">What are Cookies</h1>
                <div class="info"><a class="icon-link" href="http://www.clicklaboratory.com/" target="_blank" rel="noreferrer">http://www.clicklaboratory.com/</a></div>
            </div>
            ...
            <div className='col-md-12'>
                <div class="left-right-offset">
                    ...
                    <h3>THE COOKIES WE SET</h3><h3>Account related cookies</h3>
                    ...
                    <p>However, if you are still looking for more information then you can contact us through &nbsp;<a href="mailto:info@meek.co">info@meek.co.</a></p></div>
            </div>
            <Footer />
        </div>
    )
