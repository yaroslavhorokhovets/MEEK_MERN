...
function $884c64d19340d345$var$Flex(props, ref) {
    ...
    if (props.gap != null) style1.gap = (0, $9LQqs$responsiveDimensionValue)(props.gap, matchedBreakpoints);
    if (props.columnGap != null) style1.columnGap = (0, $9LQqs$responsiveDimensionValue)(props.columnGap, matchedBreakpoints);
    if (props.rowGap != null) style1.rowGap = (0, $9LQqs$responsiveDimensionValue)(props.rowGap, matchedBreakpoints);
    return /*#__PURE__*/ (0, $9LQqs$react).createElement("div", {
        ...(0, $9LQqs$filterDOMProps)(otherProps),
